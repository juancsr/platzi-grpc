...
func (x *testServiceTakeTestClient) Send(m *TakeTestRequests) error {
	return x.ClientStream.SendMsg(m)
}
...
func (x *testServiceTakeTestServer) Recv() (*TakeTestRequests, error) {
	m := new(TakeTestRequests)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
